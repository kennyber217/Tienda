...
<head>
  ...
  <title>Pedidos Online | Login </title>
  <!-- icon -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b><?php echo $title; ?></b></a>
    </div>
    <div class="card-body">
      ...
      <form id="form_login">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-6">
            <a type="button" class="btn btn-danger btn-block" href="<?php echo base_url();?>">Cancelar</a>
          </div> 
          <div class="col-6">
